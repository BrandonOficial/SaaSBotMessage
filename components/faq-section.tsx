...
const faqData = [
  {
    question: "O que é Pointer e para quem ele é?",
    answer:
      "Pointer é uma plataforma de desenvolvimento alimentada por IA, projetada para desenvolvedores, times e organizações que querem acelerar seu workflow de desenvolvimento. É perfeito para desenvolvedores individuais que buscam melhorar sua produtividade e times que buscam ferramentas de colaboração sem complicações.",
  },
  {
    question: "Como funciona a revisão de código da Pointer?",
    answer:
  ...
  {
    question: "Posso integrar a Pointer com meus ferramentas existentes?",
    answer:
  ...
  {
    question: "Como funcionam os agentes de código paralelo?",
    answer:
  ...
  {
    question: "Minha código é seguro com a Pointer?",
    answer:
      ...
      <div className="self-stretch pt-8 pb-8 md:pt-14 md:pb-14 flex flex-col justify-center items-center gap-2 relative z-10">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-[18.20px] break-words">
            Tudo o que você precisa saber sobre Pointer e como ele pode
            transformar seu workflow de vendas
          </p>
        </div>
      </div>
